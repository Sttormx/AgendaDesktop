...
public final class TarefaMain extends javax.swing.JFrame 
{
    ...
    public void loadTarefaPanel()
    {
        DefaultListModel listModel;
        listModel = new DefaultListModel();
        
        int tamh = Main.tarefa.getInstanceArrayLength();
        ...
        if (tamh > 0)
        {
            for(int i = 0; i < tamh; i++)
            {
                ...
                listModel.addElement(Main.tarefa.tarefas[i].getTarefaTitulo());
            }        
        }

        jTarefas.setModel(listModel);
    }
    ...
    private void initComponents() {
        ...
        jTarefas = new javax.swing.JList<>();
        ...
        jScrollPane1.setViewportView(jTarefas);
    ...
    private javax.swing.JList<String> jTarefas;
